# Datenschutz — Inhalts-Extraktion (1:1 aus Webflow-Export)

Quelle: `datenschutz.html`, Live-URL: https://tristanweithaler.com/datenschutz

## Meta

- **Seitentitel (`<title>`):** Datenschutz
- **Meta-Description:** "Discover my favorite books, the tools I use, and download my free guide on branding. No email required." — *Hinweis: generischer Platzhaltertext, inhaltlich passend zu keiner Seite der aktuellen Site (wirkt wie unveränderter Webflow-Vorlagentext). Gleicher Text auch als og:description/twitter:description. Für die Astro-Migration sollte hier eine echte, seitenspezifische Description gesetzt werden.*
- **Meta Robots:** `noindex`
- **Canonical:** https://tristanweithaler.com/datenschutz
- **Sprache:** de

## Seiteninhalt

Überschriften-Hierarchie ist original aus dem Webflow-Rich-Text übernommen (inkl. Sprüngen wie h4 vor erstem h3 — das ist so im Original, keine Korrektur vorgenommen). Leere Absätze (nur Zero-Width-Joiner `‍`), die im Original nur als visuelle Abstandshalter zwischen Blöcken dienen, wurden nicht übernommen (siehe `legal-layout.md` für dieses Formatierungsmuster).
...
## Cookie-Consent-Integration auf dieser Seite

Ja, auf `datenschutz.html` ist wie auf allen Seiten das Finsweet-Cookie-Consent-Widget (`fs-cc`) eingebunden:

- Ein Cookie-Banner unten mit Text "Wenn Sie auf **„Alle Cookies akzeptieren"** klicken, stimmen Sie der Speicherung von Cookies auf Ihrem Gerät zu, um die Navigation auf der Website zu verbessern, die Nutzung der Website zu analysieren und unsere Marketingaktivitäten zu unterstützen. Weitere Informationen finden Sie in unserer [Datenschutzrichtlinie](datenschutz.html)" (Buttons: „Alle Cookies akzeptieren", „Ablehnen") sowie Link "Cookie Einstellungen bearbeiten" (`fs-cc="open-preferences"`).
- Ein permanentes Cookie-Manager-Icon am Bildschirmrand (`fs-cc="open-preferences"`), über das die Präferenzen jederzeit erneut geöffnet werden können.
- Ein Präferenzen-Panel mit Kategorien: Essentiell (immer aktiv), Marketing, Personalisierung, Analysen (je mit Checkbox + Beschreibungstext).

Siehe `legal-layout.md` für die vollständige Spezifikation dieser Cookie-Consent-Komponente.
